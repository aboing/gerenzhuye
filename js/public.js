...
function params(o){ //灏嗚浼犵粰鍚庡彴鐨勫弬鏁拌浆鍖栦负瀛楃涓诧紝浠ュ姞鍏ュ埌url涓�
    var arr = [];
    for(var i in o){
...
$.ajaxp = function(args){ //鍒涘缓script鑺傜偣锛屽悜鍚庡彴璇锋眰js锛宻rc鑺傜偣鎼哄甫鎴戠殑鍙傛暟淇℃伅
    var script = document.createElement("script");
    script.type="text/javascript";
    script.src = args.url + "?" + params(args.params);
    document.body.appendChild(script);
    var time = setTimeout(args.params.callback + "()", 6000); //璁剧疆瓒呮椂鏃堕棿锛岃寰椾笉濡ュ彲浠ユ洿鏀�
